...
<div class="form_box">
    <form action="" method="POST" enctype="multipart/form-data">
        <table align="center" width="100%">
            <tr>
                <td colspan="7">
                    <h1>Edit <strong>product type information</strong></h1>
            ...
            <tr>
                <td><b>Change to new product type :</b></td>
                <td><input type="text" name="product_cat" value="<?php echo($fetch_cat['cat_title']); ?>" size="60" required value=""></td>
            </tr>

            <tr>
                <td colspan="7"><input type="submit" name="edit_cat" value="Save and changes" id=""></td>
            </tr>
        </table>
    </form>
</div>
